  ...
  useEffect(() => {
    const fetchOfferListings = async () => {
      try {
        ...
        console.log('offer data', data); // Logging fetched data
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto">
        ...
        <Link to={"/search"} className='text-xs sm:text-sm text-blue-800 font-bold:underline'>
          Let's get started...
        </Link>
      </div>
          ...
          offerListings.map((listing) => (
            <SwiperSlide key={listing._id}>
              {listing.imageUrls && listing.imageUrls.length > 0 ? (
                <div
                  style={{
                    background: `url(${listing.imageUrls[0]}) center center / contain no-repeat`,paddingTop:'50%'
                  }}
                  className="h-[500px]"
                >
                </div>
